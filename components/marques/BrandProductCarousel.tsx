 ...
 *   - >0 products             → scroll-snap carousel
 */
              ...
              {products.map((p) => (
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <h3 className="text-sm font-bold text-[var(--brand-dark)] leading-snug mb-2 line-clamp-2">
                      {p.title}
                    </h3>
                    {p.description && (
                    ...
                    <span className="mt-auto inline-flex items-center gap-1.5 text-xs font-semibold text-[var(--brand-dark)] group-hover:text-[var(--brand-accent)] transition-colors">
                      Voir le produit
