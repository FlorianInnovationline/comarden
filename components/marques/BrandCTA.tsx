  ...
  return (
    <section className="bg-primary text-white py-16 sm:py-20 lg:py-24 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <Reveal>
          <p className="text-xs sm:text-sm font-bold uppercase tracking-[0.2em] text-[var(--brand-primary)] mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[var(--brand-primary)] text-[var(--brand-on-primary)] font-semibold px-8 py-3.5 text-base transition-transform duration-300 hover:scale-105 hover:shadow-xl"
            >
              Demander un devis
