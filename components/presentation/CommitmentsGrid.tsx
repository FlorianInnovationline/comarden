          ...
          {commitments.map((commitment, index) => {
            ...
            return (
              <Reveal key={commitment.title} delay={index * 100}>
                <div className="group p-8 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-accent/30 transition-all duration-300 rounded-sm">
                  <div className="w-12 h-12 bg-accent/20 rounded-lg flex items-center justify-center mb-6 group-hover:bg-accent/30 transition-colors duration-300">
